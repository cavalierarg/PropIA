...
export default async function ReelsPage() {
        ...
        <div className="max-w-3xl mx-auto w-full py-12 sm:py-16 px-4 flex flex-col items-center gap-10">
          ...
          <div className="flex flex-col items-center gap-3 text-center">
            ...
            <p className="text-base text-slate-500 leading-relaxed max-w-xl mx-auto">
              La IA investiga qué formatos están en tendencia y genera un guion escena por escena para grabar tu Reel en minutos. Exclusivo del Plan Pro.
            </p>
          </div>
          ...
          <div className="w-full relative select-none" aria-hidden>
            <div className="blur-sm pointer-events-none">
              <div className="flex flex-col gap-3">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="flex gap-3 items-start p-4 rounded-xl border border-slate-200 bg-slate-50">
                    <div className="w-7 h-7 rounded-full bg-[#00c9c9]/30 shrink-0" />
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="bg-white/90 backdrop-blur-sm rounded-2xl px-6 py-4 border border-[#00c9c9]/30 shadow-lg text-center">
                ...
                <p className="text-xs text-slate-500 mt-1">Guion escena por escena · Tendencias en tiempo real</p>
              </div>
            </div>
          </div>
          ...
          <ul className="flex flex-col gap-2.5 text-sm text-left w-full max-w-md">
            {[
              "Guion completo escena por escena para grabar",
              "Investigación en tiempo real de formatos en tendencia",
              "Adaptado al mercado inmobiliario hispanohablante",
  ...
  return (
    <main className="flex flex-col gap-6 py-6 sm:gap-8 sm:py-8">
      ...
      <ReelsContent initialIsPro={plan === "pro" || plan === "pro_max"} />
    </main>
  );
}
