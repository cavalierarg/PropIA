...
export const metadata = { title: "Descripción para Portal — PropIA" };
...
export default async function DescripcionPage() {
        ...
        <div className="max-w-3xl mx-auto w-full py-12 sm:py-16 px-4 flex flex-col items-center gap-10">
          ...
          <div className="flex flex-col items-center gap-3 text-center">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold text-[#0f3460] leading-tight">
              Descripción para Portal Inmobiliario
            </h1>
            <p className="text-base text-slate-500 leading-relaxed max-w-xl mx-auto">
              Esta herramienta es exclusiva del Plan Pro. Upgradea para acceder a descripciones optimizadas para Zonaprop, Idealista y más portales.
            </p>
          </div>
          ...
          <div className="w-full relative select-none" aria-hidden>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="bg-white/90 backdrop-blur-sm rounded-2xl px-6 py-4 border border-[#00c9c9]/30 shadow-lg text-center">
                ...
                <p className="text-xs text-slate-500 mt-1">Zonaprop · Idealista · Fotocasa · MercadoLibre</p>
              </div>
            </div>
          </div>
          ...
          <ul className="flex flex-col gap-2.5 text-sm text-left w-full max-w-md">
            {[
              "Texto profesional optimizado para Zonaprop e Idealista",
              "Estilo técnico y detallado, diferente a los posts de redes",
              "Adaptado al portal destino (Fotocasa, MercadoLibre y más)",
  ...
  return (
    <main className="flex flex-col gap-6 py-6 sm:gap-8 sm:py-8">
      ...
      <DescripcionContent initialIsPro={plan === "pro" || plan === "pro_max"} />
    </main>
  );
}
